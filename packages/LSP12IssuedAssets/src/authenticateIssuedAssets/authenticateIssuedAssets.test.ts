...
// lsp-utils
import { IssuerAssets } from '@lukso/lsp-utils-constants';
import { addDigitalAssetCreators, removeDigitalAssetCreators } from '@lukso/lsp4-utils';

// utils
import { authenticateIssuedAssets } from './authenticateIssuedAssets';
import { removeIssuedAssets } from '../removeIssuedAssets';
import { addIssuedAssets } from '../addIssuedAssets';
...
describe('authenticateIssuedAssets', () => {
    ...
    it('should throw when token address is hex with less than 20 bytes', async () => {
        // invalid address that is only 19 bytes long
